...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-orange-300 page-width px-30 mx-auto">
      <div>
        <div className="pt-18">
          <div className="font-pacifico text-2xl cursor-pointer pb-8">LOGO</div>
          <div className="w-82 pl-21">
            <form className="mb-8">
      ...
      {/* <div className="md:w-5/12 flex flex-col md:mx-auto lg:mx-auto">
          <div className="flex w-9/12 mx-auto px-3 mb-5">
      ...
      {/* <div className="md:w-7/12 flex justify-center items-center">
          <div
            ...
            className="login-banner rounded-xl flex justify-center items-center"
          >
            <div
            ...
            >
              <div className="w-10/12 mx-auto">
                <div className="loginsection bottom-0">
                  <Slider {...settings}>
