        ...
        <div className='relative p-1 rounded-2xl shadow-md bg-white'>
          <table className='font-mulish mt-5'>
            <tr className='font-normal text-base leading-6'>
              ...
              <td className='pr-10 pb-6'>Block</td>
            </tr>
            ...
            <tr className='font-normal text-base leading-6 hover:bg-gray-100 cursor-pointer'>
              ...
              <td className='w-22 pr-8 rounded-r-full'>
                <div className='text-center'>
                  <button
                    className='w-28 py-1.5 bg-opacity-25 my-2 text-base font-light font-mulish'
                    style={{
              ...
              <td className='w-22 pr-8 rounded-r-full'>
                <div className='text-center'>
                  <button
                    className='w-28 py-1.5 my-2 text-white bg-red-400 bg-opacity-90 text-base font-light font-mulish'
                    style={{
            ...
            <tr className='font-normal text-base leading-6 hover:bg-gray-100 cursor-pointer'>
              ...
              <td className='w-22 pr-8 rounded-r-full'>
                <div className='text-center'>
                  <button
                    className='w-28 py-1.5 my-2 text-white bg-black bg-opacity-80 text-base font-light font-mulish'
                    style={{
                      borderRadius: "10px",
                    }}
                  >
            ...
            <tr className='font-normal text-base leading-6 hover:bg-gray-100 cursor-pointer'>
              ...
              <td className='w-22 pr-8 rounded-r-full'>
                <div className='text-center'>
                  <button
                    className='w-28 py-1.5 my-2 text-base font-light font-mulish'
                    style={{
